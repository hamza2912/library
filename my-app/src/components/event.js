    ...
    if (type === 'detailed'){
        ...
        return (
            ...
            <div className='w-full lg:mt-8 mt-2 lg:pl-40 lg:pr-32 pl-8 pr-6 flex flex-col lg:flex-row items-center py-6 bg-search'>
                <div className='lg:w-3/5 w-full mx-auto'>
                    <h2 className='text-center lg:text-4xl text-lg font-medium'>{title}</h2>
        ...
        return (
            ...
            <div className='flex flex-col rounded-lg shadow-lg'>
                <img className='w-full h-auto rounded-t-lg' src={imageUrl} alt="" />
                <div className='w-full bg-white rounded-b-lg p-2'>
                <p className='text-sm'>{title}</p>
                <p className='text-xs line-clamp overflow-ellipsis text-gray-700'>{description}</p>
                </div>
            </div>
